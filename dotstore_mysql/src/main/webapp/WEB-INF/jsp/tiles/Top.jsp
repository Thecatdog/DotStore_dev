...
<link type="text/css" rel="stylesheet" href="../style/top.css?ver=4" />
	...
	<nav class="navbar navbar-expand-lg top-nav-color">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		    <div class="navbar-nav">
		      <a class="nav-item nav-link category-item" href="#">C2P</a>
		      <a class="nav-item nav-link category-item" href="#">P2P</a>
		      <a class="nav-item nav-link category-item" href="#">AUCTION</a>
		    </div>
		    <form class="go-sign-form">
				<a href="<c:url value="/shop/signonForm.do"/>" class="btn btn-gradient">LOGIN</a>
				<a href="<c:url value="/shop/newAccount.do"/>" class="btn btn-gradient">SIGN UP</a>
			</form>
		</div>
	</nav>
</div>
